...
import com.buding.mj.common.DQMJCardDealer;
...
public class DQMJStateDispatcher extends MJStateDispatcher<DQMJDesk> {
	...
	public DQMJStateDispatcher(){
		this.mCardDealer = new DQMJCardDealer();
		this.mCardLogic = new DQMJCardLogic();
