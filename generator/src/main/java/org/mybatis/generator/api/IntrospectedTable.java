...
public abstract class IntrospectedTable {
    ...
    public String getMyBatis3SqlMapNamespace() {
        ...
        if (namespace == null) {
        	String tmp = context.getProperty("defualtNamespaceType");
    		if ("SameAsModel".equalsIgnoreCase(tmp)) {
    			namespace = tableConfiguration.getProperty("referCls");
    			if(namespace == null) {
    				namespace = internalAttributes.get(InternalAttribute.ATTR_BASE_RECORD_TYPE);
    			}    			
    		} else {
