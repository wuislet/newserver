...
public abstract class BaseRules implements Rules {
	...
	public BaseRules(IntrospectedTable introspectedTable) {
		...
		String modelOnly = tableConfiguration
				.getProperty(PropertyRegistry.TABLE_MODEL_ONLY);
	...
	public boolean generateUpdateByPrimaryKeySelective() {
		...
		boolean rc = tableConfiguration
				.isUpdateByPrimaryKeySelectiveStatementEnabled()
				&& introspectedTable.hasPrimaryKeyColumns()
	...
	public boolean generateUpdateByExampleSelective() {
		...
		boolean rc = tableConfiguration
				.isUpdateByExampleSelectiveStatementEnabled();
	...
	public String getRerferCls() {
		return this.tableConfiguration.getReferCls();
	}
}
