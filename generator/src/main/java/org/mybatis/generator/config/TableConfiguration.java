...
public class TableConfiguration extends PropertyHolder {
    ...
    public TableConfiguration(Context context) {
        ...
        String enableInsert = context.getProperty("enableInsert");
        String enableInsertSelective = context.getProperty("enableInsertSelective");
        String enableSelectByPrimaryKey = context.getProperty("enableSelectByPrimaryKey");
        String enableSelectByExample = context.getProperty("enableSelectByExample");
        String enableUpdateByPrimaryKey = context.getProperty("enableUpdateByPrimaryKey");
        String enableUpdateByPrimaryKeySelective = context.getProperty("enableUpdateByPrimaryKeySelective");
        String enableDeleteByPrimaryKey = context.getProperty("enableDeleteByPrimaryKey");
        String enableDeleteByExample = context.getProperty("enableDeleteByExample");
        String enableCountByExample = context.getProperty("enableCountByExample");
        String enableUpdateByExample = context.getProperty("enableUpdateByExample");
        String enableUpdateByExampleSelective = context.getProperty("enableUpdateByExampleSelective");
        String selectByPrimaryKeyQueryId = context.getProperty("selectByPrimaryKeyQueryId");
        String selectByExampleQueryId = context.getProperty("selectByExampleQueryId");
        
        if (stringHasValue(enableInsert)) {
            setInsertStatementEnabled(isTrue(enableInsert));
        }
        
        if (stringHasValue(enableInsertSelective)) {
            setInsertSelectiveStatementEnabled(isTrue(enableInsertSelective));
        }
        ...
        if (stringHasValue(enableUpdateByPrimaryKeySelective)) {
            setUpdateByPrimaryKeySelectiveStatementEnabled(
        ...
        if (stringHasValue(enableUpdateByExampleSelective)) {
            setUpdateByExampleSelectiveStatementEnabled(
                    isTrue(enableUpdateByExampleSelective));
        }

        if (stringHasValue(selectByPrimaryKeyQueryId)) {
            setSelectByPrimaryKeyQueryId(selectByPrimaryKeyQueryId);
        }

        if (stringHasValue(selectByExampleQueryId)) {
            setSelectByExampleQueryId(selectByExampleQueryId);
        }
    }
	...
	public String getReferCls() {
		return this.getProperty("referCls");
	}	
}
